...
impl Ticket {
    ...
    pub fn set_title(&mut self, ns:String){
        Self::val_title(&ns);
        self.title = ns;
    }

    pub fn set_description(&mut self, ns:String){
        Self::val_description(&ns);
        self.description = ns;
    }

    pub fn set_status(&mut self, ns:String){
        Self::val_status(&ns);
        self.status = ns;
    }
}
